...
./ingest_data.py --user Postgres --password Postgres --host localhost --port 5431 --db ny_taxi --table-name yellow_taxi_trips --url "https://github.com/DataTalksClub/nyc-tlc-data/releases/download/yellow/yellow_tripdata_2021-01.csv.gz"
